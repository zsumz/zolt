...
final class HelpOptionHighlighterTest {
    ...
    void highlightsOnlyOptionTokensInOptionLines() {
        String input = String.join(
                "\n",
                "      --test=<testSelectors>, --color <WHEN>, --package [<SPEC>], --profile[=<profile>], --member...",
        ...
        assertEquals(
                String.join(
                        "\n",
                        "      \u001B[1;36m--test\u001B[0m\u001B[36m=<testSelectors>\u001B[0m, \u001B[1;36m--color\u001B[0m\u001B[36m <WHEN>\u001B[0m, \u001B[1;36m--package\u001B[0m\u001B[36m [<SPEC>]\u001B[0m, \u001B[1;36m--profile\u001B[0m\u001B[36m[=<profile>]\u001B[0m, \u001B[1;36m--member\u001B[0m\u001B[36m...\u001B[0m",
