...
public final class ProjectConfigDependencyMutator {
    private ProjectConfigDependencyMutator() {
    }

    public static ProjectConfig addDependency(
    ...
    public static ProjectConfig addVersionRefDependency(
            ProjectConfig config,
            DependencySection section,
            String coordinate,
            String versionRef,
    ...
    public static ProjectConfig addManagedDependency(ProjectConfig config, DependencySection section, String coordinate) {
        ProjectConfigDependencyState state = ProjectConfigDependencyState.from(config);
        state = productionSection(section)
                ? state.removeProductionDependency(coordinate)
                : state.removeDependency(section, coordinate);
    ...
    public static ProjectConfig removeDependency(ProjectConfig config, DependencySection section, String coordinate) {
        return ProjectConfigDependencyState.from(config)
                .removeDependency(section, coordinate)
                .toConfig(config);
    }

    public static ProjectConfig addPlatform(ProjectConfig config, String coordinate, String version) {
    ...
    public static ProjectConfig addVersionRefPlatform(
            ProjectConfig config,
            String coordinate,
            String versionRef,
            String version) {
    ...
    public static ProjectConfig removePlatform(ProjectConfig config, String coordinate) {
        ProjectConfig updated = ProjectConfigDependencyState.from(config)
