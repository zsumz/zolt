...
/**
 * How a Central Portal publish concluded. {@link #UPLOADED} is the default no-wait result: the bundle
 * was accepted and validation continues on the Portal, with no status request made. {@link #PUBLISHED}
 * and {@link #AWAITING_MANUAL_RELEASE} are only reached when {@code --wait} polled the deployment to a
