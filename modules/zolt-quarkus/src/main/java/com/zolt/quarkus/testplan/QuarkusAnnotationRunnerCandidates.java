package com.zolt.quarkus.testplan;
...
public final class QuarkusAnnotationRunnerCandidates {
    private static final String QUARKUS_TEST = "@QuarkusTest";

    private QuarkusAnnotationRunnerCandidates() {
    }

    public static List<QuarkusUnsupportedTest> select(List<QuarkusUnsupportedTest> tests) {
