...
import com.zolt.quarkus.annotation.QuarkusAnnotationProgrammaticRunner;
...
public final class QuarkusAnnotationFailureDiagnostics {
    ...
    public QuarkusAnnotationFailureDiagnostics(PrintStream out) {
        this.out = out;
    ...
    public void writeFailure(List<String> testClasses, ClassLoader quarkusRuntimeClassLoader, Throwable failure) {
