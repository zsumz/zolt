...
public final class QuarkusTestProfileDiagnostic {
    ...
    public static List<String> testClasses(Index index) {
        if (index == null) {
            return List.of();
        }
    ...
    public static List<TestClassProfile> testClassProfiles(Index index) {
        if (index == null) {
            return List.of();
        }
    ...
    public static String joinedProfiles(List<TestClassProfile> profiles) {
        if (profiles.isEmpty()) {
            return "<none>";
        }
        return profiles.stream()
    ...
    public static String joinedProfileMatches(List<TestClassProfile> profiles, String activeProfile) {
        if (profiles.isEmpty()) {
            return "<none>";
        }
        return profiles.stream()
    ...
    public record TestClassProfile(String testClass, String profileClass) {
