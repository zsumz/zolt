...
public final class QuarkusAdditionalApplicationArchiveBuildItemBridge {
    ...
    public static void addTestOutputArchive(BuildChainBuilder builder) {
    ...
    public static Optional<Path> testOutputDirectory() {
