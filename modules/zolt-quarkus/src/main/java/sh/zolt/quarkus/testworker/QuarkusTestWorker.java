...
import sh.zolt.quarkus.annotation.QuarkusAnnotationWorkerRunner;
import sh.zolt.quarkus.testworker.descriptor.QuarkusTestRunnerDescriptor;
import sh.zolt.quarkus.testworker.descriptor.QuarkusTestRunnerDescriptorReader;
import sh.zolt.quarkus.testplan.QuarkusUnsupportedTest;
import java.io.PrintStream;
import java.nio.file.Path;

public final class QuarkusTestWorker {
    public static final String MAIN_CLASS = "sh.zolt.quarkus.testworker.QuarkusTestWorker";
