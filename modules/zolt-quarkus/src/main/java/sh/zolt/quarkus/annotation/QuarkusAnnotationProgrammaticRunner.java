...
import sh.zolt.quarkus.annotation.diagnostic.QuarkusAnnotationFailureDiagnostics;
...
public final class QuarkusAnnotationProgrammaticRunner {
    public static final String MAIN_CLASS = "sh.zolt.quarkus.annotation.QuarkusAnnotationProgrammaticRunner";
