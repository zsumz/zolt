...
import sh.zolt.quarkus.production.QuarkusProductionApplicationHandle;
import sh.zolt.quarkus.production.QuarkusProductionApplicationSummary;
import java.io.PrintStream;
import java.nio.file.Path;

public final class QuarkusBootstrapWorker {
    public static final String MAIN_CLASS = "sh.zolt.quarkus.bootstrap.QuarkusBootstrapWorker";
