...
public final class QuarkusAdditionalBeanBuildItemBridge {
    private QuarkusAdditionalBeanBuildItemBridge() {
    }

    public static void markBuilderUnremovable(Object builder) throws ReflectiveOperationException {
        Method setUnremovable = builder.getClass().getMethod("setUnremovable");
        setUnremovable.invoke(builder);
    }

    public static void setBuilderDefaultScope(
            Object builder,
