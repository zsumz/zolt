...
final class QuarkusApplicationModelFactoryModelDoubles {
    private QuarkusApplicationModelFactoryModelDoubles() {
    }

    public static final class FakeApplicationModelBuilder {
        private FakeResolvedDependencyBuilder appArtifact;
        private QuarkusApplicationModelFactoryArtifactDoubles.FakePlatformImports platformImports;
        private final List<FakeResolvedDependencyBuilder> dependencies = new ArrayList<>();
        private final List<QuarkusApplicationModelFactoryArtifactDoubles.FakeArtifactKey> parentFirstArtifacts = new ArrayList<>();
        private final List<QuarkusApplicationModelFactoryArtifactDoubles.FakeArtifactKey> runnerParentFirstArtifacts = new ArrayList<>();
        private final List<QuarkusApplicationModelFactoryArtifactDoubles.FakeArtifactKey> reloadableWorkspaceModules = new ArrayList<>();
        private final Map<QuarkusApplicationModelFactoryArtifactDoubles.FakeArtifactKey, List<String>> removedResources =
        ...
        public FakeApplicationModelBuilder setPlatformImports(
                QuarkusApplicationModelFactoryArtifactDoubles.FakePlatformImports platformImports) {
        ...
        public FakeApplicationModelBuilder addParentFirstArtifact(
                QuarkusApplicationModelFactoryArtifactDoubles.FakeArtifactKey artifactKey) {
            parentFirstArtifacts.add(artifactKey);
            return this;
        }

        public FakeApplicationModelBuilder addRunnerParentFirstArtifact(
                QuarkusApplicationModelFactoryArtifactDoubles.FakeArtifactKey artifactKey) {
            runnerParentFirstArtifacts.add(artifactKey);
            return this;
        }

        public FakeApplicationModelBuilder addReloadableWorkspaceModule(
                QuarkusApplicationModelFactoryArtifactDoubles.FakeArtifactKey artifactKey) {
    ...
    public record FakeApplicationModel(
            ...
            List<QuarkusApplicationModelFactoryArtifactDoubles.FakeArtifactKey> parentFirstArtifacts,
            List<QuarkusApplicationModelFactoryArtifactDoubles.FakeArtifactKey> runnerParentFirstArtifacts,
            List<QuarkusApplicationModelFactoryArtifactDoubles.FakeArtifactKey> reloadableWorkspaceModules,
            Map<QuarkusApplicationModelFactoryArtifactDoubles.FakeArtifactKey, List<String>> removedResources) {
    }
}
